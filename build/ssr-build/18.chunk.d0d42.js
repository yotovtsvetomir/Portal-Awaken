...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Mycomments; });
...
var _ref11 = Object(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(__WEBPACK_IMPORTED_MODULE_6__Postlist__["a" /* default */], { link: 'https://www.portal.allawaken.com/api/mycomments' });

var Mycomments = function (_Component) {
  _inherits(Mycomments, _Component);

  function Mycomments() {
    _classCallCheck(this, Mycomments);

    return _possibleConstructorReturn(this, _Component.apply(this, arguments));
  }

  Mycomments.prototype.componentDidMount = function componentDidMount() {
  ...
  Mycomments.prototype.componentDidUpdate = function componentDidUpdate() {
    fetch('https://www.portal.allawaken.com/api/myprofile', {
      method: 'get'
    }).then(function (response) {
      return response.text().then(function (text) {
  ...
  Mycomments.prototype.render = function render() {
